...
var SideBySideRenderer = function SideBySideRenderer(props) {
  ...
  try {
    if (switchSides) {
      ...
      inPlace = alwaysInPlace || elementDimensions.width * 2 + elementOffset.left > window.innerWidth;
    }
  } catch (e) {}
  ...
  return _react["default"].createElement("div", {
    ...
    style: _objectSpread({}, _styles["default"].getZoomContainerStyle(smallImageSize.width, smallImageSize.height, inPlace, switchSides), {
